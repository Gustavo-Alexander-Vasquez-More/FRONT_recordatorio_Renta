          ...
          return (
            <>
              <Page size="LETTER">
                ...
                <Text style={{ position: "absolute", top: "25.4%", fontSize: 9, left: "21%" }}>
                ...
                {dat.productos &&
                  dat.productos.map((prod, idx) => (
                    <React.Fragment key={idx}>
                      ...
                      >
                        {prod.precio_x_cantidad.toFixed(2)}
                      </Text>
                    </React.Fragment>
                  ))}
                  <View
